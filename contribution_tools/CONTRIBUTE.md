# Contributing to SafetyCulture Tools

Welcome! This guide will help you contribute to this repository while maintaining code quality and consistency.
...
Make sure you're in the project root, not inside venv/:
```bash
cd contribution_tools/
make install
```
...
Thank you for contributing! Your improvements help make SafetyCulture API automation better for everyone. 🚀
